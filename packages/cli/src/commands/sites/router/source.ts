...
// The site's middleware Edge Script: maps production hosts to the published deploy dir and preview hosts to theirs. Previews are per-deploy pull zones (`sites-dpl-{id}-{suffix}.b-cdn.net`). (See AGENTS.md and the SOURCE comments below; BunnySDK hook names are the platform contract.)
