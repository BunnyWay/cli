...
export const pullzonesDeleteCommand = defineCommand<DeleteArgs>({
  command: "delete [name-or-id]",
  describe: "Delete a pull zone.",
  examples: [
    ["$0 pullzones delete", "Delete selected pull zone"],
    ["$0 pullzones delete my-zone", "Delete by name"],
    ["$0 pullzones delete 12345", "Delete by ID"],
    ["$0 pullzones delete --force", "Skip confirmation"],
  ],
