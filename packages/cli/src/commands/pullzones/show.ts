...
export const pullzonesShowCommand = defineCommand<ShowArgs>({
  command: "show [name-or-id]",
  describe: "Show pull zone details.",
  examples: [
    ["$0 pullzones show", "Show selected pull zone"],
    ["$0 pullzones show my-zone", "Show by name"],
    ["$0 pullzones show 12345", "Show by ID"],
  ],
