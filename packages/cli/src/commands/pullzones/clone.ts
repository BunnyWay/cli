...
export const pullzonesCloneCommand = defineCommand<CloneArgs>({
  command: "clone <source> <target>",
  describe: "Clone a pull zone.",
  examples: [
    ["$0 pullzones clone my-zone my-clone", "Clone by name"],
    ["$0 pullzones clone 12345 my-clone", "Clone source by ID"],
  ],
