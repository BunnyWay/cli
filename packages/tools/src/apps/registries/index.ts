...
export type { ContainerRegistryModel, RegistryType } from "./api.ts";
export {
  fetchRegistries,
  fetchRegistry,
  registryTypeForServer,
} from "./api.ts";
export type { Registry } from "./model.ts";
export { RegistrySchema, toRegistry } from "./model.ts";
...
export const registriesTools: Tool[] = [
  registriesList,
  registriesGet,
  registriesCreate,
  registriesUpdate,
