...
│   │       ├── sandbox.ts                # Sandbox class: create/get/fromHandle, runCommand (blocking/detached + onStdout/onStderr), writeFiles, readFile, mkDir, exposePort, domain, getEnv/setEnv/unsetEnv (persisted env), delete, disconnect, Symbol.dispose/asyncDispose
